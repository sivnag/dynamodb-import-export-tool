...
public class ParallelScanExecutor2 {
    ...
    public SegmentedScanResult grab() throws ExecutionException,
        ...
        ScanSegmentWorker2 sw = workers[segment];
     ...
     */
    public void addWorker(ScanSegmentWorker2 ssw, int segment) {
        workers[segment] = ssw;
        exec.submit(ssw);
    }
}
